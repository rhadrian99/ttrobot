...
void Servo::write(int value)
{
    ...
    if (value < MIN_PULSE_WIDTH)
    {
        ...
        value2 = map(value, 0, 180, this->min, this->max);
        //Serial.print(F("PULS: "));Serial.println(MIN_PULSE_WIDTH,DEC);
        
    }
    this->writeMicroseconds(value2);
    //Serial.print(F("Value position: "));Serial.println(value2,DEC);
}
...
void Servo::setTimerWidth(int value)
{
    ...
    if (this->attached())
    {
        ...
        //Serial.print(F("Setting timer width to: "));Serial.println(this->timer_width,DEC);
